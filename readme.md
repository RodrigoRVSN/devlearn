...
- Ao clonar o repositório, ou baixar o zip deste, entre, através do terminal, na pasta respectiva ao backend e utilize o comando `yarn dev` para inicializar o servidor backend local (localhost:4000 - Necessário instalar o <a href="https://www.postgresql.org/">driver do Postgres</a>). Para sincronizar o banco de dados, utilize o comando `yarn typeorm scheme:sync` com o pgadmin4 aberto.
